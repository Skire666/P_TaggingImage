...
class FileController:
    ...
    def folder_path(self) -> str:
        ...
        return self.file_model.folder_path

    @property
    def current_index(self) -> int:
        """Retourne l'index courant de navigation."""
        return self.file_model.current_index

    @current_index.setter
    def current_index(self, value: int) -> None:
        """Met a jour l'index courant de navigation."""
        self.file_model.current_index = value
    ...
    def file_exists(self, filename: str) -> bool:
        ...
        return self.file_model.file_exists(filename)
    ...
    def build_tags(
        ...
        if progress_callback is None:
            ...
            self.tag_model.build(self.file_model.file_list, progress_callback)

    def tag_dict(self) -> OrderedDict[str, int]:
        """Retourne le dictionnaire des tags agreges."""
        return self.tag_model.tag_dict

    def find_available_name(self, base: str, ext: str, *, ignore: str = "") -> str | None:
        """Trouve le premier nom libre au format `base - compteur.ext`."""
