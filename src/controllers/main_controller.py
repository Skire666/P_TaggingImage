...
class MainController:
    ...
    def _build_new_filename(self, old_filename: str) -> str | None:
        """Construit un nom initial `base - 1000.ext` depuis le champ vue."""
    ...
    def _resolve_conflict(self, new_filename: str) -> str | None:
        ...
        resolved = self.file_controller.find_available_name(base_prefix, ext)
        if resolved:
            return resolved
    ...
    def _perform_rename(self, old_filename: str, new_filename: str) -> None:
        """Applique le renommage et rafraichit l'interface."""
        try:
    ...
    def _reload_folder(self, folder_path: str) -> None:
        """Recharge entierement les modeles/vue pour un nouveau dossier."""
